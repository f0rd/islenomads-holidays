...
import MaldivesMapGoogle from "./pages/MaldivesMapGoogle";
import MaldivesMapSplitScreen from "./pages/MaldivesMapSplitScreen";
...
import MaldivesMapSimple from "./pages/MaldivesMapSimple";
