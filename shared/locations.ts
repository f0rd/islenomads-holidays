...
export const ALL_ISLANDS: IslandLocation[] = [
  ...
  { id: 4, name: 'HP Reef', slug: 'hp-reef', type: 'poi' },
  ...
  { id: 20, name: 'Felidhoo Kandu', slug: 'felidhoo-kandu', type: 'poi' },
  ...
  { id: 26, name: 'Kandooma Thila', slug: 'kandooma-thila', type: 'poi' },
  ...
  { id: 42, name: 'Fulidhoo Kandu', slug: 'fulidhoo-kandu', type: 'poi' },
  ...
  { id: 64, name: 'Rasdhoo Madivaru', slug: 'rasdhoo-madivaru', type: 'poi' },
  { id: 66, name: 'Thoddoo House Reef', slug: 'thoddoo-house-reef', type: 'poi' },
  { id: 68, name: 'Ukulhas', slug: 'ukulhas', type: 'island' },
  { id: 69, name: 'Ukulhas House Reef', slug: 'ukulhas-house-reef', type: 'poi' },
  { id: 70, name: 'Veligandu Reef', slug: 'veligandu-reef', type: 'poi' },
  ...
  { id: 92, name: 'Naifaru Kandu', slug: 'naifaru-kandu', type: 'poi' },
  ...
  { id: 100, name: 'Banana Reef', slug: 'banana-reef', type: 'poi' },
