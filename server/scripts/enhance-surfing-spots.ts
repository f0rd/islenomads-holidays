...
async function enhanceSurfingSpots() {
        ...
        messages: [
          {
            role: "system",
            content:
              "You are an expert surfing guide for the Maldives. Provide detailed, accurate, and engaging descriptions of surfing spots.",
          },
...
enhanceSurfingSpots().catch(console.error);
