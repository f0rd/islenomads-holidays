...
## Data Organization - Separate Dive Sites from Islands
- [x] Add POI type field to island_guides table (dive_site, reef, channel, etc.)
- [x] Categorize all 14 POIs with specific types
- [x] Update Explore Maldives to show separate tabs for dive sites
- [x] Modify filtering logic to distinguish between islands and dive sites
- [x] Update ActivitySpotCard to show in correct category
- [x] Test data separation and filtering
- [x] Verify UI displays correct categorization
